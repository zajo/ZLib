...
def main(ctx):
  ...
  return [
    ...
    linux_cxx("valgrind", "", packages=" ".join(addon_clang_11["apt"]["packages"]) + " autotools-dev automake", image="cppalliance/droneubuntu1804:1", buildtype="valgrind", environment={"COMMENT": "valgrind","B2_TOOLSET": "clang-11", "B2_CXXSTD":"17", "B2_DEFINES": "BOOST_NO_STRESS_TEST=1", "B2_VARIANT": "debug", "B2_TESTFLAGS": "testing.launcher=valgrind","VALGRIND_OPTS": "--error-exitcode=1" }),
